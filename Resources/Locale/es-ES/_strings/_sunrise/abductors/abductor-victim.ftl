...
abductor-victim-role-greeting =
    ...
    Utiliza cualquier medio a tu alcance para completar la tarea.
roles-abductor-victim-objective = Cumple tus objetivos dados por un órgano extraño.
roles-abductor-victim-name = Víctima de secuestradores